...
class _AddEditEventScreenState extends State<AddEditEventScreen> {
  ...
  void _save() {
    ...
    final event = ReminderEvent(
      ...
      notificationScheduledAt: widget.initialEvent?.notificationScheduledAt,
      notificationError: widget.initialEvent?.notificationError,
      sourceType: widget.initialEvent?.sourceType ??
          (widget.parsedEvent == null
              ? ReminderSourceType.manual
              : ReminderSourceType.chat),
